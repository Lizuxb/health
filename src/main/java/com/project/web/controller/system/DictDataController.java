...
public class DictDataController extends BaseController {
    ...
    @PostMapping("/checkValueUnique")
    @ResponseBody
    public String checkValueUnique(SysDictData dict){
        if(dict.getDictCode()!=null){
            dict.getParams().put("isCheckDictValue","1");
        }
        return dictDataService.selectDictDataList(dict).size()+"";
    }
}
