...
public class CommonController
{
    ...
    @GetMapping("profile/upload/{fileName}")
    public void fileDownload2(@PathVariable("fileName")String fileName,String realName, HttpServletResponse response, HttpServletRequest request)
    {
