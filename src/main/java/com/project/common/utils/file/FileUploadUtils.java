...
import com.project.common.config.ServerConfig;
...
import com.project.web.controller.common.CommonController;
...
public class FileUploadUtils {
    ...
    public static final String upload(String baseDir, MultipartFile file, String extension)
        ...
        if(StringUtils.isEmpty(extension)){
            ...
            extension = fileRealName.substring(fileRealName.lastIndexOf("."));
        }
     ...
     * @throws Exception
     */
    public static final String upload(MultipartFile file, String extension)throws Exception{
        String fileName = FileUploadUtils.upload(Global.getUploadPath(), file,extension);
        return getUrl() + CommonController.UPLOAD_PATH + fileName;
    }
