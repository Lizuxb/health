...
public class Global {
    ...
    public static String getName() {
        return StringUtils.nvl(getConfig("project.name"), "ProjectName");
    }
    ...
    public static String getAuthor() {
        return StringUtils.nvl(getConfig("gen.author"), "author");
    }
    ...
    public static String getEmailHost(){
        return StringUtils.nvl(getConfig("email.host"), "");
    }
    public static String getEmailUser(){
        return StringUtils.nvl(getConfig("email.user"), "");
    }
    public static String getEmailPassword(){
        return StringUtils.nvl(getConfig("email.passWord"), "");
    }
}
