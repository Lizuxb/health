...
(function ($) {
    $.extend({
        ...
        modal: {
            ...
            // 弹出层指定宽度btn为''时弹窗下部不显示任何按钮，为undefined或者null时默认['确定', '关闭']
            open: function (title, url, width, height,btn) {
                //如果是移动端，就使用自适应大小弹窗
        ...
        operate: {
            ...
            add: function(id,width,height) {
                ...
                $.modal.open("添加" + $.table._option.modalName, url,width,height);
            },
            // 修改信息
        ...
        common: {
            ...
            visible: function (value) {
                if ($.common.isEmpty(value) || value == false) {
                    return false;
                }
                return true;
            },
